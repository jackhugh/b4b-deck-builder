...
export const cards: CardInterface[] = [
	...
	},
	{
		...
		effects: [
			...
			{ isTeamEffect: false, type: 'special', isBuff: false, description: 'DISABLES: Sprint', appliedTo: [] },
		],
		...
		effects: [
			{
				...
				type: 'special',
				isBuff: true,
				description: 'When you use a Medical Accessory, it has a 25% chance to have 100% increased effect.',
				appliedTo: [],
			},
		],
		...
		effects: [
			{
				...
				type: 'special',
				isBuff: true,
				description: 'When you exit a starting saferoom your team gains + 15% Move Speed for 30 seconds.',
				appliedTo: [],
			},
		],
		name: 'On Your Mark',
	...
	},
	{
		...
		effects: [
			...
			{ isTeamEffect: false, type: 'special', isBuff: true, description: 'More weapons spawn.', appliedTo: [] },
		],
	...
	},
	{
		...
		effects: [
			{ isTeamEffect: false, type: 'special', isBuff: true, description: '+100% Fire damage.', appliedTo: [] },
			{
				isTeamEffect: false,
				type: 'special',
				isBuff: true,
		...
		effects: [
			{
				...
				type: 'special',
				isBuff: true,
				description: 'Pain Medse you apply also grant +25 Damage for 60 seconds.',
				appliedTo: [],
			},
		],
